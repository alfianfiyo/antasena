...
/***/ }),
/***/ "../demo7/src/js/layout/extended/quick-panel2.js":
/*!******************************************************!*\
  !*** ../demo7/src/js/layout/extended/quick-panel.js ***!
  \******************************************************/
/*! no static exports found */
...
var KTLayoutQuickPanel2 = function() {
    // Private properties
    var _element;
    var _offcanvasObject;
    var _notificationsElement;
    ...
    var _init = function() {
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'kt_quick_panel2_close',
            toggleBy: 'kt_quick_panel2_toggle'
        });
    }
    ...
    return {
        init: function(id) {
            _element = KTUtil.getById(id);
            _notificationsElement = KTUtil.getById('kt_quick_panel2_notifications');
            _logsElement = KTUtil.getById('kt_quick_panel2_logs');
            _settingsElement = KTUtil.getById('kt_quick_panel2_settings');
...
if (true) {
    module.exports = KTLayoutQuickPanel2;
}


/***/ }),
/***/ "../demo7/src/js/layout/extended/quick-panel3.js":
/*!******************************************************!*\
  !*** ../demo7/src/js/layout/extended/quick-panel.js ***!
  \******************************************************/
/*! no static exports found */
...
var KTLayoutQuickPanel3 = function() {
    // Private properties
    var _element;
    var _offcanvasObject;
    var _notificationsElement;
    ...
    var _init = function() {
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'kt_quick_panel3_close',
            toggleBy: 'kt_quick_panel3_toggle'
        });
    }
    ...
    return {
        init: function(id) {
            _element = KTUtil.getById(id);
            _notificationsElement = KTUtil.getById('kt_quick_panel3_notifications');
            _logsElement = KTUtil.getById('kt_quick_panel3_logs');
            _settingsElement = KTUtil.getById('kt_quick_panel3_settings');
...
if (true) {
    module.exports = KTLayoutQuickPanel3;
}


/***/ }),
/***/ "../demo7/src/js/layout/extended/quick-panel4.js":
/*!******************************************************!*\
  !*** ../demo7/src/js/layout/extended/quick-panel.js ***!
  \******************************************************/
/*! no static exports found */
...
var KTLayoutQuickPanel4 = function() {
    // Private properties
    var _element;
    var _offcanvasObject;
    var _notificationsElement;
    ...
    var _init = function() {
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'kt_quick_panel4_close',
            toggleBy: 'kt_quick_panel4_toggle'
        });
    }
    ...
    return {
        init: function(id) {
            _element = KTUtil.getById(id);
            _notificationsElement = KTUtil.getById('kt_quick_panel4_notifications');
            _logsElement = KTUtil.getById('kt_quick_panel4_logs');
            _settingsElement = KTUtil.getById('kt_quick_panel4_settings');
...
if (true) {
    module.exports = KTLayoutQuickPanel4;
}
...
KTUtil.ready(function() {
    ...
    if (typeof KTLayoutQuickPanel !== 'undefined') {
     ...
     if (typeof KTLayoutQuickPanel2 !== 'undefined') {
        KTLayoutQuickPanel2.init('kt_quick_panel2');
    }

    if (typeof KTLayoutQuickPanel3 !== 'undefined') {
        KTLayoutQuickPanel3.init('kt_quick_panel3');
    }
    if (typeof KTLayoutQuickPanel4 !== 'undefined') {
        KTLayoutQuickPanel4.init('kt_quick_panel4');
    }
...
window.KTLayoutQuickPanel2 = __webpack_require__(/*! @/src/js/layout/extended/quick-panel.js */ "../demo7/src/js/layout/extended/quick-panel2.js");
window.KTLayoutQuickPanel3 = __webpack_require__(/*! @/src/js/layout/extended/quick-panel.js */ "../demo7/src/js/layout/extended/quick-panel3.js");
window.KTLayoutQuickPanel4 = __webpack_require__(/*! @/src/js/layout/extended/quick-panel.js */ "../demo7/src/js/layout/extended/quick-panel4.js");
